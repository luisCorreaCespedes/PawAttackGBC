.module script_s16_p_hit1

.include "vm.i"
.include "data/game_globals.i"
.include "macro.i"

.globl _plat_walk_vel, _plat_walk_acc, _plat_run_acc, _plat_min_vel, _pl_vel_y, b_wait_frames, _wait_frames, _fade_frames_per_step, ___bank_scene_15, _scene_15, ___bank_scene_37, _scene_37, ___bank_scene_6, _scene_6

.area _CODE_255

ACTOR = -4

___bank_script_s16_p_hit1 = 255
.globl ___bank_script_s16_p_hit1
...
3$:
        ; If Variable .EQ Value
        VM_IF_CONST .EQ         VAR_CONTINUAR, 0, 5$, 0
        ; If Variable .EQ Value
        VM_IF_CONST .EQ         VAR_CONTINUAR, 1, 7$, 0
        VM_JUMP                 8$
7$:
        ; Load Scene
        VM_SET_CONST_INT8       _fade_frames_per_step, 7
