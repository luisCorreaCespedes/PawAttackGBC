...
___bank_script_s16a13_interact = 255
.globl ___bank_script_s16a13_interact

_script_s16a13_interact::
        ; Local Actor
        VM_PUSH_CONST           0
        VM_PUSH_CONST           0
        VM_PUSH_CONST           0
...
1$:
        ...
        VM_RPN
            ...
            .R_OPERATOR .DIV
            .R_STOP
        VM_SET                  VAR_S16A13_LOCAL_0, .ARG1
        VM_SET                  VAR_S16A13_LOCAL_1, .ARG0
        VM_POP                  2
        ...
        VM_RPN
            .R_REF      VAR_S16A13_LOCAL_0
            .R_INT16    128
            .R_OPERATOR .MUL
            .R_REF      VAR_S16A13_LOCAL_1
            .R_INT16    128
            .R_OPERATOR .MUL
            .R_STOP
