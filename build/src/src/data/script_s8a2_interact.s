.module script_s8a2_interact

.include "vm.i"
.include "data/game_globals.i"
.include "macro.i"

.globl _plat_walk_vel, _plat_max_fall_vel, _plat_walk_acc, _plat_run_acc, _plat_min_vel, _plat_grav, b_wait_frames, _wait_frames, _fade_frames_per_step, ___bank_scene_9, _scene_9

.area _CODE_255

ACTOR = -4

___bank_script_s8a2_interact = 255
.globl ___bank_script_s8a2_interact

_script_s8a2_interact::
        ; Local Actor
        VM_PUSH_CONST           0
        VM_PUSH_CONST           0
        VM_PUSH_CONST           0
