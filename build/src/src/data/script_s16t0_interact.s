.module script_s16t0_interact

.include "vm.i"
.include "data/game_globals.i"
.include "macro.i"

.globl _fade_frames_per_step, ___bank_scene_15, _scene_15, ___bank_scene_37, _scene_37, ___bank_scene_6, _scene_6

.area _CODE_255

ACTOR = -4

___bank_script_s16t0_interact = 255
.globl ___bank_script_s16t0_interact

_script_s16t0_interact::
        VM_LOCK
...
1$:
        ; If Variable .EQ Value
        VM_IF_CONST .EQ         VAR_CONTINUAR, 0, 3$, 0
        ; If Variable .EQ Value
        VM_IF_CONST .EQ         VAR_CONTINUAR, 1, 5$, 0
        VM_JUMP                 6$
5$:
        ; Load Scene
        VM_SET_CONST_INT8       _fade_frames_per_step, 7
